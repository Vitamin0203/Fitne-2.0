...
// скрипт для табов
var tabsTriggersitems = document.querySelectorAll('.faq__item');
tabsTriggersitems.forEach(function (item) {
  return item.addEventListener('click', function (e) {
    ...
    document.querySelectorAll('.faq__item').forEach(function (child) {
      return child.classList.remove('faq__item--activ');
    });
    document.querySelectorAll('.faq-wrapper__item').forEach(function (child) {
      return child.classList.remove('faq-wrapper__item--activ');
    });
