...
// скрипт для табов
var tabsTriggersitems = document.querySelectorAll('.tabs__triggers-item');
tabsTriggersitems.forEach(function (item) {
  return item.addEventListener('click', function (e) {
    e.preventDefault();
    var id = e.target.getAttribute('href').replace('#', '');
    document.querySelectorAll('.tabs__triggers-item').forEach(function (child) {
      return child.classList.remove('tabs__triggers-item--activ');
    });
    document.querySelectorAll('.tabs__content-item').forEach(function (child) {
      return child.classList.remove('tabs__content-item--activ');
    });
